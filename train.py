...
from dataset import build_dataset, merge_images_to_batch
...
def get_args_parser():
    ...
    parser.add_argument('--print_feq', default=10, type=int)
...
def main(args):
    ...
    data_loader_train = DataLoader(dataset_train, batch_sampler=batch_sampler_train,
                                   collate_fn=merge_images_to_batch, num_workers=args.num_workers,
                                   pin_memory=True)
    data_loader_val = DataLoader(dataset_val, args.batch_size, sampler=sampler_val,
                                 drop_last=False, collate_fn=merge_images_to_batch, num_workers=args.num_workers,
                                 pin_memory=True)
