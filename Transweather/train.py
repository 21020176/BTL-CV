...
import wandb
wandb.login()
wandb.init(project="Transweather")
...
print('All_weather old_val_psnr: {0:.2f}, old_val_ssim: {1:.4f}'.format(old_val_psnr1, old_val_ssim1))
...
#-------------------------------------------------------------------------------------------------------------
    ...
    print("All weather")
    wandb.log({"train_psnr" : train_psnr})
    wandb.log({"val_psnr1" : val_psnr1})
    wandb.log({"val_ssim1" : val_ssim1})
